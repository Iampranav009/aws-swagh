...
export default function Leaderboard() {
  ...
  return (
    <div className="bg-[#0B0F1A] min-h-screen pt-[72px] flex flex-col md:flex-row relative">
      ...
      <main className="flex-1 flex flex-col min-h-[calc(100vh-72px)] overflow-x-hidden relative">
        ...
        <div className="flex-1 px-4 sm:px-6 max-w-6xl mx-auto w-full mb-8 relative z-10 pt-8 sm:pt-10 pb-28 md:pb-10">
